...
import (
	...
	"github.com/hashicorp/consul/agent/agentpb/connect"
...
func extractSignedResponse(resp *agentpb.AutoConfigResponse) (*structs.SignedResponse, error) {
...
func mapstructureTranslateToStructs(in interface{}, out interface{}) error {
	decoder, err := mapstructure.NewDecoder(&mapstructure.DecoderConfig{
		DecodeHook: agentpb.HookPBTimestampToTime,
		Result:     out,
	})
