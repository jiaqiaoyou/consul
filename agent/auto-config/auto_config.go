...
func (ac *AutoConfig) getInitialConfigurationOnce(ctx context.Context, csr string, key string) (*agentpb.AutoConfigResponse, error) {
	...
	var resp agentpb.AutoConfigResponse
...
func (ac *AutoConfig) recordResponse(resp *agentpb.AutoConfigResponse) error {
...
func (ac *AutoConfig) update(resp *agentpb.AutoConfigResponse) error {
	if err := ac.updateConfigFromResponse(resp); err != nil {
		return err
	}
...
func (ac *AutoConfig) updateConfigFromResponse(resp *agentpb.AutoConfigResponse) error {
...
// TLS configurator.
func (ac *AutoConfig) updateTLSFromResponse(resp *agentpb.AutoConfigResponse) error {
